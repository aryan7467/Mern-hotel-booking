...
export const BookingModal = ({ open, handleClose, hotelInfo }) => {
  ...
  const handleReserve = async () => {
    ...
    await addDoc(bookings, {
      ...
      price: hotelInfo?.pricePerNight*10 * getTotalNightsBooked(),
      bookedBy: {
        uid,
        displayName,
      },
    ...
    >
      <Box sx={bookModalStyle}>
        <Typography id="modal-modal-title" variant="h6" component="h2">
          Rs{hotelInfo?.pricePerNight*10} /night
        </Typography>
        ...
        >
          <Typography
            ...
            variant="h6"
          >
            Rs{hotelInfo?.pricePerNight*10} x{" "}
          ...
          >
            Rs
            {dates[0]?.endDate
              ? hotelInfo?.pricePerNight*10 * getTotalNightsBooked()
              : 0}
          </Typography>
        </Box>
        <Typography
